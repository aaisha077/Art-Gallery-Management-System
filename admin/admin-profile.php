...
if (strlen($_SESSION['agmsaid']==0)) {
    ...
    if(isset($_POST['submit']))
  {
    ...
    // Validate admin name (only letters and spaces)
    if (!preg_match("/^[A-Za-z ]+$/", $aname)) {
        echo "<script>alert('Admin name should contain only alphabets and spaces.');</script>";
                      ...
                      <div class="panel-body bio-graph-info">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input class="form-control" id="email" name="email" type="email" value="<?php echo $row['Email'];?>" readonly>
                            </div>
                          </div>
                          <?php } ?>
                          <div class="form-group">
