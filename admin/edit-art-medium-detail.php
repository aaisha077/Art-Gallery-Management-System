  ...
  header('location:logout.php');
    ...
    if(isset($_POST['submit'])) {
        ...
        if (!in_array($artmed, $allowed_mediums)) {
            ...
            // Check if medium already exists (excluding current record)
            $check_query = mysqli_query($con, "SELECT * FROM tblartmedium WHERE ArtMedium = '$artmed' AND ID != '$eid'");
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" id="artmed" name="artmed" required>
                        <option value="<?php echo $row['ArtMedium'];?>"><?php echo $row['ArtMedium'];?></option>
